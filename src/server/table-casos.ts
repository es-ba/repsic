...
export function casos(context:TableContext):TableDefinition {
    ...
    tableDef.fields.unshift({ name: "consistir"     , label:'Consistir'             , typeName: 'boolean'   , editable:false, serverSide:true, clientSide:'correrConsistencias',});
    tableDef.fields.unshift({ name: "cambio_estado" , label:'cambiar a'             , typeName: 'jsonb'     , editable:false, serverSide:true, clientSide:'cambiarEstados'     ,}),
