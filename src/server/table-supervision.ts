...
export function supervision(context:TableContext):TableDefinition {
    ...
    return {
        ...
        fields: [
            ...
            { name: "generar"            , typeName: "bigint"  , editable:false, serverSide:true, clientSide:'generarRelevamiento'},
            { name: "tipo_recorrido"     , typeName: "integer" , editable:false}, 
            { name: "comuna"             , typeName: "text"    , editable:false},
            { name: "descripcion_barrio" , typeName: "text"    , editable:false},
        ],
