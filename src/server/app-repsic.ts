...
import { estados_roles       } from "./table-estados_roles";
    ...
    getMenu(){
        let menu:MenuDefinition = {menu:[
            ...
            {menuType:'menu', name:'usuarios', menuContent:[
                ...
                {menuType:'table', name:'estados_roles'},
            ]}
        ]}
    ...
    prepareGetTables(){
        ...
        be.appendToTableDefinition('parametros',function(tableDef){
            tableDef.fields.push(
                ...
                {name:'gra_puntos_por_recorrido'      , typeName:'integer'   , label:'granularidad puntos por recorrido'    , editable: true, nullable: false, defaultDbValue:10  },
                {name:'gra_puntos_todos_recorridos'   , typeName:'integer'   , label:'granularidad puntos todos recorridos' , editable: true, nullable: false, defaultDbValue:100 },
