...
export function grupo_personas(context:TableContext):TableDefinition {
    ...
    let def = {
        ...
        fields: [
            ...
            { name: "r0"            , label:'nombre'                , typeName: 'text'    },
            { name: "r1"            , label:'desde ciudad'          , typeName: 'integer' },
            { name: "r2"            , label:'4 o mas noches'        , typeName: 'integer' },
            { name: "r3"            , label:'donde vivio antes'     , typeName: 'integer' },
            { name: "r4"            , label:'motivo vino'           , typeName: 'integer' },
            { name: "r4_esp"        , label:'motivo vino esp'       , typeName: 'text'    },
            { name: "r7"            , label:'donde pasa noche'      , typeName: 'integer' },
            { name: "r7_esp"        , label:'otro_esp'              , typeName: 'text'    },
