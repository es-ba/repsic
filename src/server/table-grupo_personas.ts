...
export function grupo_personas(context:TableContext):TableDefinition {
    ...
    let def = {
        ...
        fields: [
            ...
            { name: "r5"            , label:'hace cuanto vive calle', typeName: 'integer' },
            { name: "r6"            , label:'dias sem duerme calle' , typeName: 'integer' },
            { name: "r7"            , label:'donde pasa noche'      , typeName: 'integer' },
            { name: "r7_esp"        , label:'otro_esp'              , typeName: 'text'    },
            { name: "r8"            , label:'act sem pasada'        , typeName: 'integer' },
            { name: "r9_1"          , label:'cartoneo'              , typeName: 'integer' },
            { name: "r9_2"          , label:'venta amb'             , typeName: 'integer' },
            { name: "r9_3"          , label:'changas'               , typeName: 'integer' },
            { name: "r9_4"          , label:'pide dinero'           , typeName: 'integer' },
            { name: "r9_5"          , label:'rel dep'               , typeName: 'integer' },
            { name: "r9_6"          , label:'otro'                  , typeName: 'integer' },
            { name: "r9_esp"        , label:'esp'                   , typeName: 'text'    },
            { name: "r10_1"         , label:'jub o pen'             , typeName: 'integer' },
            { name: "r10_2"         , label:'prog CP'               , typeName: 'integer' },
            { name: "r10_3"         , label:'AUH'                   , typeName: 'integer' },
            { name: "r10_4"         , label:'sub o plan'            , typeName: 'integer' },
            { name: "r10_5"         , label:'otro ing'              , typeName: 'integer' },
            { name: "r10_esp"       , label:'esp'                   , typeName: 'text'    },
            { name: "r11_1"         , label:'centro sala'           , typeName: 'integer' },
            { name: "r11_2"         , label:'cons u hosp'           , typeName: 'integer' },
            { name: "r11_3"         , label:'guardia hosp'          , typeName: 'integer' },
            { name: "r11_4"         , label:'Cov Port Salud'        , typeName: 'integer' },
            { name: "r11_5"         , label:'Estab OS'              , typeName: 'integer' },
            { name: "r11_6"         , label:'otro'                  , typeName: 'integer' },
            { name: "r11_esp"       , label:'esp'                   , typeName: 'text'    },
