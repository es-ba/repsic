...
export function personas(context:TableContext):TableDefinition {
    ...
    let def = {
        ...
        fields: [
            ...
            { name: "sc13_esp"      , label:'esp doc'                    , typeName: 'text'    },
            ...
            { name: "sc17_esp"      , label:'otro esp'                   , typeName: 'text'    },     
            ...
            { name: "sc19_esp"      , label:'esp otro'                   , typeName: 'text'    },
            ...
            { name: "sc20_esp"      , label:'esp otro'                   , typeName: 'text'    }, 
