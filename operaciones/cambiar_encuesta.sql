...
update tem set json_encuesta = (select json_encuesta from tem where operativo = 'REPSIC_242' and enc = '92201')
where operativo = 'REPSIC_242' and enc = '93001';

update tareas_tem set estado = 'D'
where operativo = 'REPSIC_242' and enc = '93001' and tarea = 'ingr';


update tareas_tem set estado = 'A'
where operativo = 'REPSIC_242' and enc = '92201' and tarea = 'ingr';


update tem set json_encuesta = null
where operativo = 'REPSIC_242' and enc = '92201';
