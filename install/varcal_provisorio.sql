...
----
--mejora
            INSERT INTO "repsic212_grupo_personas_calculada" ("operativo","id_caso") 
              SELECT "operativo","id_caso" FROM "grupo_personas";

            INSERT INTO "repsic212_personas_calculada" ("operativo","id_caso","p0") 
              SELECT "operativo","id_caso","p0" FROM "personas";

            INSERT INTO "repsic212_supervision_calculada" ("recorrido") 
...
BEGIN
  ...
  ----
      ...
      FROM "grupo_personas"  
        ,LATERAL (
          ...
          count(nullif(CASE WHEN "personas"."sc2"=1 THEN true ELSE NULL END,false)) as cant_refe
            FROM "personas" JOIN "repsic212_personas_calculada" using ("operativo","id_caso","p0")
                WHERE "grupo_personas"."operativo"="personas"."operativo" AND "grupo_personas"."id_caso"="personas"."id_caso"
        ) as personas_agg
      WHERE "grupo_personas"."operativo"="repsic212_grupo_personas_calculada"."operativo" AND "grupo_personas"."id_caso"="repsic212_grupo_personas_calculada"."id_caso" AND "grupo_personas"."operativo"=p_operativo AND "grupo_personas"."id_caso"=p_id_caso;
    UPDATE repsic212_grupo_personas_calculada
      SET 
    ...
    FROM personas inner join grupo_personas using (operativo, id_caso) inner join repsic212_grupo_personas_calculada using (operativo, id_caso)
        LEFT JOIN (
    ...
    WHERE "personas"."operativo"="repsic212_personas_calculada"."operativo" AND "personas"."id_caso"="repsic212_personas_calculada"."id_caso" AND "personas"."p0"="repsic212_personas_calculada"."p0" 
    ...
    UPDATE repsic212_supervision_calculada
      ...
      FROM "supervision"  
        ,LATERAL (
          ...
          FROM "grupo_personas" JOIN "repsic212_grupo_personas_calculada" using ("operativo","id_caso")
