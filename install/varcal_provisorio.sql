      ...
      FROM "grupo_personas"  
        ,LATERAL (
          ...
          count(nullif(CASE WHEN "personas"."sc2"=1 THEN true ELSE NULL END,false)) as cant_refe
            FROM "personas" JOIN "repsic211_personas_calculada" using ("operativo","id_caso","p0")
    ...
    UPDATE repsic211_supervision_calculada
      ...
      FROM "supervision"  
        ,LATERAL (
          ...
          FROM "grupo_personas" JOIN "repsic211_grupo_personas_calculada" using ("operativo","id_caso")
