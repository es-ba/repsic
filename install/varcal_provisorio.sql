...
drop table if exists "repsic_252_grupo_personas_calculada";
drop table if exists "repsic_252_personas_calculada";
drop table if exists "repsic_252_coordinacion_calculada";
...
--set role repsic252_admin;

create table "repsic_252_grupo_personas_calculada" (
  operativo             text,
  id_caso               text,
  "cant_0a14_mu" bigint, 
...
--grant select, insert, update, delete, references on "repsic_252_grupo_personas_calculada" to "repsic252_admin";
--grant all on "repsic_252_grupo_personas_calculada" to "repsic252_owner";

create table "repsic_252_personas_calculada" (
  "operativo" text,
  "id_caso" text,
  "persona" bigint, 
  "sexor" bigint,
...
--grant select, insert, update, delete, references on "repsic_252_personas_calculada" to "repsic252_admin";
--grant all on "repsic_252_personas_calculada" to "repsic252_owner";

create table "repsic_252_coordinacion_calculada" (
  "operativo" text,
  "recorrido" bigint,
  "area" bigint,
  "cant_form" bigint
...
--grant select, insert, update, delete, references on "repsic_252_coordinacion_calculada" to "repsic252_admin";
--grant all on "repsic_252_coordinacion_calculada" to "repsic252_owner";

-- conss
alter table "repsic_252_grupo_personas_calculada" add constraint "operativo<>''" check ("operativo"<>'');
alter table "repsic_252_grupo_personas_calculada" add constraint "id_caso<>''" check ("id_caso"<>'');
alter table "repsic_252_personas_calculada" add constraint "operativo<>''" check ("operativo"<>'');
alter table "repsic_252_personas_calculada" add constraint "id_caso<>''" check ("id_caso"<>'');

-- FKs
alter table "repsic_252_grupo_personas_calculada" add constraint  "repsic_252_grupo_personas_calculada grupo_personas REL" foreign key ("operativo", "id_caso") references "grupo_personas" ("operativo", "id_caso")  on delete cascade on update cascade;
alter table "repsic_252_personas_calculada" add constraint  "repsic_252_personas_calculada personas REL" foreign key ("operativo", "id_caso", "persona") references "personas" ("operativo", "id_caso", "persona")  on delete cascade on update cascade;
alter table "repsic_252_coordinacion_calculada" add constraint  "repsic_252_coordinacion_calculada coordinacion REL" foreign key ("operativo","recorrido","area") references "coordinacion" ("operativo","recorrido","area")  on delete cascade on update cascade;
-- index
create index "operativo,id_caso 4 repsic_252_grupo_personas_calculada IDX" ON "repsic_252_grupo_personas_calculada" ("operativo", "id_caso");
create index "operativo,id_caso,persona 4 repsic_252_personas_calculada IDX" ON "repsic_252_personas_calculada" ("operativo", "id_caso", "persona");
create index "recorrido 4 repsic_252_coordinacion_calculada IDX" ON "repsic_252_coordinacion_calculada" ("operativo","recorrido","area");
----
--mejora
            INSERT INTO "repsic_252_grupo_personas_calculada" ("operativo","id_caso") 
              SELECT "operativo","id_caso" FROM "grupo_personas";

            INSERT INTO "repsic_252_personas_calculada" ("operativo","id_caso","persona") 
              SELECT "operativo","id_caso","persona" FROM "personas";

            INSERT INTO "repsic_252_coordinacion_calculada" ("operativo","recorrido","area") 
...
BEGIN
  ...
  ----
    UPDATE repsic_252_grupo_personas_calculada
      SET 
      ...
      FROM "grupo_personas"  
        ,LATERAL (
          ...
          FROM "personas" JOIN "repsic_252_personas_calculada" using ("operativo","id_caso","persona")
            WHERE "grupo_personas"."operativo"="personas"."operativo" AND "grupo_personas"."id_caso"="personas"."id_caso"
        ) as personas_agg
      WHERE "grupo_personas"."operativo"="repsic_252_grupo_personas_calculada"."operativo" AND "grupo_personas"."id_caso"="repsic_252_grupo_personas_calculada"."id_caso" AND "grupo_personas"."operativo"=p_operativo AND "grupo_personas"."id_caso"=p_id_caso;
    UPDATE repsic_252_grupo_personas_calculada
      SET 
      ...
      WHERE "grupo_personas"."operativo"="repsic_252_grupo_personas_calculada"."operativo" AND "grupo_personas"."id_caso"="repsic_252_grupo_personas_calculada"."id_caso" AND "grupo_personas"."operativo"=p_operativo AND "grupo_personas"."id_caso"=p_id_caso;
    UPDATE repsic_252_personas_calculada
      SET 
          sexor = null2zero(referente.sc3), -- VER QUIZAS QUIERA EL NULL!!!
          edadr = null2zero(referente.sc4)
    FROM personas inner join grupo_personas using (operativo, id_caso) inner join repsic_252_grupo_personas_calculada using (operativo, id_caso)
        LEFT JOIN (
    ...
    WHERE "personas"."operativo"="repsic_252_personas_calculada"."operativo" AND "personas"."id_caso"="repsic_252_personas_calculada"."id_caso" AND "personas"."persona"="repsic_252_personas_calculada"."persona" 
      AND "personas"."operativo"=p_operativo AND "personas"."id_caso"=p_id_caso;
    UPDATE repsic_252_coordinacion_calculada
      SET 
      ...
      FROM "coordinacion"  
        ,LATERAL (
          ...
          FROM "grupo_personas" JOIN "repsic_252_grupo_personas_calculada" using ("operativo","id_caso")
          WHERE "coordinacion"."recorrido"="grupo_personas"."u1"
        ) as grupo_personas_agg
      WHERE "coordinacion"."operativo"="repsic_252_coordinacion_calculada"."operativo" 
        AND "coordinacion"."recorrido"="repsic_252_coordinacion_calculada"."recorrido" 
        AND "coordinacion"."area"="repsic_252_coordinacion_calculada"."area" 
...
-----
select update_varcal('REPSIC_252');
UPDATE operativos SET calculada=now()::timestamp(0) WHERE operativo='REPSIC_252';
UPDATE tabla_datos SET generada=now()::timestamp(0) WHERE operativo='REPSIC_252' AND tipo='calculada';
-----