...
drop table if exists "repsic_242_grupo_personas_calculada";
drop table if exists "repsic_242_personas_calculada";
drop table if exists "repsic_242_coordinacion_calculada";
...
--set role repsic242_admin;

create table "repsic_242_grupo_personas_calculada" (
  operativo             text,
  id_caso               text,
  "cant_0a14_mu" bigint, 
...
--grant select, insert, update, delete, references on "repsic_242_grupo_personas_calculada" to "repsic242_admin";
--grant all on "repsic_242_grupo_personas_calculada" to "repsic242_owner";

create table "repsic_242_personas_calculada" (
  "operativo" text,
  "id_caso" text,
  "persona" bigint, 
  "sexor" bigint,
...
--grant select, insert, update, delete, references on "repsic_242_personas_calculada" to "repsic242_admin";
--grant all on "repsic_242_personas_calculada" to "repsic242_owner";

create table "repsic_242_coordinacion_calculada" (
  "recorrido" bigint, 
  "cant_form" bigint
, primary key ("recorrido")
);
--grant select, insert, update, delete, references on "repsic_242_coordinacion_calculada" to "repsic242_admin";
--grant all on "repsic_242_coordinacion_calculada" to "repsic242_owner";

-- conss
alter table "repsic_242_grupo_personas_calculada" add constraint "operativo<>''" check ("operativo"<>'');
alter table "repsic_242_grupo_personas_calculada" add constraint "id_caso<>''" check ("id_caso"<>'');
alter table "repsic_242_personas_calculada" add constraint "operativo<>''" check ("operativo"<>'');
alter table "repsic_242_personas_calculada" add constraint "id_caso<>''" check ("id_caso"<>'');

-- FKs
alter table "repsic_242_grupo_personas_calculada" add constraint  "repsic_242_grupo_personas_calculada grupo_personas REL" foreign key ("operativo", "id_caso") references "grupo_personas" ("operativo", "id_caso")  on delete cascade on update cascade;
alter table "repsic_242_personas_calculada" add constraint  "repsic_242_personas_calculada personas REL" foreign key ("operativo", "id_caso", "persona") references "personas" ("operativo", "id_caso", "persona")  on delete cascade on update cascade;
--alter table "repsic_242_coordinacion_calculada" add constraint  "repsic_242_coordinacion_calculada coordinacion REL" foreign key ("recorrido") references "coordinacion" ("recorrido")  on delete cascade on update cascade;
-- index
create index "operativo,id_caso 4 repsic_242_grupo_personas_calculada IDX" ON "repsic_242_grupo_personas_calculada" ("operativo", "id_caso");
create index "operativo,id_caso,persona 4 repsic_242_personas_calculada IDX" ON "repsic_242_personas_calculada" ("operativo", "id_caso", "persona");
create index "recorrido 4 repsic_242_coordinacion_calculada IDX" ON "repsic_242_coordinacion_calculada" ("recorrido");
----
--mejora
            INSERT INTO "repsic_242_grupo_personas_calculada" ("operativo","id_caso") 
              SELECT "operativo","id_caso" FROM "grupo_personas";

            INSERT INTO "repsic_242_personas_calculada" ("operativo","id_caso","persona") 
              SELECT "operativo","id_caso","persona" FROM "personas";

            INSERT INTO "repsic_242_coordinacion_calculada" ("recorrido") 
...
BEGIN
  ...
  ----
    UPDATE repsic_242_grupo_personas_calculada
      SET 
      ...
      FROM "grupo_personas"  
        ,LATERAL (
          ...
          count(nullif(CASE WHEN "personas"."sc2"=1 THEN true ELSE NULL END,false)) as cant_refe
            FROM "personas" JOIN "repsic_242_personas_calculada" using ("operativo","id_caso","persona")
                WHERE "grupo_personas"."operativo"="personas"."operativo" AND "grupo_personas"."id_caso"="personas"."id_caso"
        ) as personas_agg
      WHERE "grupo_personas"."operativo"="repsic_242_grupo_personas_calculada"."operativo" AND "grupo_personas"."id_caso"="repsic_242_grupo_personas_calculada"."id_caso" AND "grupo_personas"."operativo"=p_operativo AND "grupo_personas"."id_caso"=p_id_caso;
    UPDATE repsic_242_grupo_personas_calculada
      SET 
      ...
      WHERE "grupo_personas"."operativo"="repsic_242_grupo_personas_calculada"."operativo" AND "grupo_personas"."id_caso"="repsic_242_grupo_personas_calculada"."id_caso" AND "grupo_personas"."operativo"=p_operativo AND "grupo_personas"."id_caso"=p_id_caso;
    UPDATE repsic_242_personas_calculada
      SET 
          sexor = null2zero(referente.sc3), -- VER QUIZAS QUIERA EL NULL!!!
          edadr = null2zero(referente.sc4)
    FROM personas inner join grupo_personas using (operativo, id_caso) inner join repsic_242_grupo_personas_calculada using (operativo, id_caso)
        LEFT JOIN (
    ...
    WHERE "personas"."operativo"="repsic_242_personas_calculada"."operativo" AND "personas"."id_caso"="repsic_242_personas_calculada"."id_caso" AND "personas"."persona"="repsic_242_personas_calculada"."persona" 
      AND "personas"."operativo"=p_operativo AND "personas"."id_caso"=p_id_caso;
    UPDATE repsic_242_coordinacion_calculada
      SET 
      ...
      FROM "coordinacion"  
        ,LATERAL (
          ...
          FROM "grupo_personas" JOIN "repsic_242_grupo_personas_calculada" using ("operativo","id_caso")
          WHERE "coordinacion"."recorrido"="grupo_personas"."u1"
        ) as grupo_personas_agg
      WHERE "coordinacion"."recorrido"="repsic_242_coordinacion_calculada"."recorrido" 
...
-----
select update_varcal('REPSIC_242');
UPDATE operativos SET calculada=now()::timestamp(0) WHERE operativo='REPSIC_242';
UPDATE tabla_datos SET generada=now()::timestamp(0) WHERE operativo='REPSIC_242' AND tipo='calculada';
-----